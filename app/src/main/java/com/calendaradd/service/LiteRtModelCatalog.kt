...
object LiteRtModelCatalog {
    ...
    val models: List<LiteRtModelConfig> = listOf(
        ...
        LiteRtModelConfig(
            ...
            description = "Small multimodal community conversion. Supports text and image, but not audio.",
            source = "LiteRT Community / community conversion",
            downloadUrl = "https://huggingface.co/litert-community/Qwen3.5-0.8B-LiteRT/resolve/main/model_multimodal.litertlm",
            fileName = "qwen3.5-0.8b-model_multimodal.litertlm",
            sizeBytes = decimalMb(1104.95),
        ...
        LiteRtModelConfig(
            ...
            description = "Larger multimodal community conversion. Supports text and image, but not audio.",
            source = "LiteRT Community / community conversion",
            downloadUrl = "https://huggingface.co/litert-community/Qwen3.5-4B-LiteRT/resolve/main/model_multimodal.litertlm",
            fileName = "qwen3.5-4b-model_multimodal.litertlm",
